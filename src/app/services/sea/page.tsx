...
export default function SeaPage() {
  return (
    <>
      <Head>
        <title>Referencement payant SEA | CLICOM</title>
        <meta name="description" content="Campagnes Google Ads et social ads pour PME suisses. Genererez des leads qualifies au meilleur cout par clic." />
      </Head>
      <div className="min-h-screen bg-white">
        ...
        <main className="py-24 md:py-32 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-8">Referencement payant / SEA</h1>
            <p className="text-xl text-slate-500 leading-relaxed mb-12 max-w-3xl">
              Lancez des campagnes Google Ads et social ads ciblees pour generer des leads qualifies des le premier jour. Budget maitrise et resultats mesurables en temps reel.
            </p>
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              {[{ value: 'Des J1', label: 'Resultats visibles' }, { value: 'Budget maitrise', label: 'CAP ajustable' }, { value: 'Reporting', label: 'Transparence totale' }].map((stat, i) => (
            ...
            <div className="mt-16 text-center">
              <Link href="/devis" className="px-10 py-5 bg-accent-500 text-white font-bold text-lg rounded-2xl hover:bg-accent-600 transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] inline-block">
                Demander mon audit SEA gratuit
              </Link>
            </div>
          </div>
        </main>
