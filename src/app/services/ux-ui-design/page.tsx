...
export default function UxUiDesignPage() {
  return (
    <>
      <Head>
        <title>UX/UI Design | CLICOM</title>
        <meta name="description" content="Design UX/UI pour sites web et applications. Interfaces claires, intuitives et optimisees pour la conversion." />
      </Head>
      <div className="min-h-screen bg-white">
        ...
        <main className="py-24 md:py-32 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-brand-50 text-brand-700 rounded-full text-xs font-semibold uppercase tracking-wider mb-6 border border-brand-200">UX/UI Design</span>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-8">UX/UI Design</h1>
            <p className="text-xl text-slate-500 leading-relaxed mb-12 max-w-3xl">
              Des interfaces claires, intuitives et esthetiques qui transforment vos visiteurs en clients. Design centre sur l utilisateur et optimise pour le taux de conversion.
            </p>
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              {[{ value: '+40%', label: 'Conversion moyenne' }, { value: 'Research', label: 'Basee utilisateurs' }, { value: 'Design system', label: 'Cohérence totale' }].map((stat, i) => (
