...
export const metadata: Metadata = {
  title: 'Referencement naturel SEO | CLICOM',
  description: 'Audit SEO et optimisation pour PME suisses. Ameliorez votre positionnement Google et attirez plus de clients qualifies.',
}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-slate-900 mb-6">Referencement naturel SEO</h1>
              <p className="text-lg text-slate-500 leading-relaxed">Optimisez votre visibilite sur Google. Audit complet, strategie de contenu et meilleures pratiques techniques pour vous propulser en tete des resultats de recherche.</p>
            </div>
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl shadow-soft">
              <Image src="/images/referencement-seo-local-pme-suisse.webp" alt="Referencement SEO local pour PME en Suisse" fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover" />
            </div>
          </div>

          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <div className="bg-slate-50 rounded-2xl p-6 text-center border border-slate-100">
              <p className="text-lg font-bold text-brand-600">+200%</p>
              <p className="text-sm text-slate-500">Trafic organique moyen</p>
            </div>
            <div className="bg-slate-50 rounded-2xl p-6 text-center border border-slate-100">
              <p className="text-lg font-bold text-brand-600">Top 3</p>
              <p className="text-sm text-slate-500">Positionnement vise</p>
            </div>
            <div className="bg-slate-50 rounded-2xl p-6 text-center border border-slate-100">
              <p className="text-lg font-bold text-brand-600">Audit offert</p>
