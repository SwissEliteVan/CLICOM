...
export default function StrategieDigitalePage() {
  return (
    <>
      <Head>
        <title>Strategie digitale | CLICOM</title>
        <meta name="description" content="Audit marketing digital et feuille de route pour PME suisses. Plan d action, calendrier editorial et pilotage de la performance." />
      </Head>
      <div className="min-h-screen bg-white">
        ...
        <main className="py-24 md:py-32 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-8">Strategie digitale</h1>
            <p className="text-xl text-slate-500 leading-relaxed mb-12 max-w-3xl">
              Definissons ensemble votre feuille de route digitale : audit marketing complet, plan d action priorise, calendrier editorial et pilotage de la performance pour atteindre vos objectifs.
            </p>
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              {[{ value: 'Audit 360 degres', label: 'Vision globale' }, { value: 'Plan action', label: 'Feuille de route' }, { value: 'KPI pilotage', label: 'Resultats mesurables' }].map((stat, i) => (
            ...
            <div className="mt-16 text-center">
              <Link href="/devis" className="px-10 py-5 bg-accent-500 text-white font-bold text-lg rounded-2xl hover:bg-accent-600 transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] inline-block">
                Demander mon audit strategique gratuit
              </Link>
            </div>
          </div>
        </main>
